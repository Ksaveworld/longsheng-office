...
本仓库是 2026-09-09 上线版本的独立源码快照，包含 React 前端、Node.js 后端、SQLite 持久化与测试。页面沿用 Shadcn Admin，使用爱化身 Logo。
...
1. 采购查看延期提醒，查询两条订单的影响，打开引用的会议记录。
2. 比较 A/B 供应方案，发起质量核验；质量负责人填写结果与证据。
3. 业务负责人预览并确认供应方案，生成采购、销售任务。
4. 采购、销售提交各自回执，负责人复核后关闭事项。
